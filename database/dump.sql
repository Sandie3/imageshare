...
--
-- Host: localhost    Database: hiraeth
-- ------------------------------------------------------
...
CREATE TABLE `follow` (
  ...
  `following` enum('true','false') DEFAULT NULL,
...
CREATE TABLE `likes` (
  ...
  `user_uid` varchar(255) DEFAULT NULL,
  `post_id` int(11) DEFAULT NULL,
  `liked` enum('true','false') DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `uploads` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `img_title` longtext NOT NULL,
  `img_desc` longtext NOT NULL,
  `img_name` longtext NOT NULL,
  `user_uid` varchar(255) NOT NULL,
  `img_mature` enum('0','1') DEFAULT '0',
  `img_tags` varchar(255) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `user_enable_mature` enum('0','1') DEFAULT '0',
...
-- Dump completed on 2019-07-03 19:37:49
